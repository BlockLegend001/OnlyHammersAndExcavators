...
public class ModItems {
    ...
    public static void addItemsToItemGroups() {
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, WOODEN_HAMMER);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, STONE_HAMMER);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, IRON_HAMMER);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, GOLD_HAMMER);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, LAPIS_HAMMER);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, REDSTONE_HAMMER);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, DIAMOND_HAMMER);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, EMERALD_HAMMER);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, NETHERITE_HAMMER);

        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, WOODEN_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, STONE_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, IRON_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, GOLD_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, LAPIS_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, REDSTONE_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, DIAMOND_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, EMERALD_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, OBSIDIAN_EXCAVATOR);
        addToItemGroup(ModItemGroup.ONLYHAMMERSANDEXCAVATORS, NETHERITE_EXCAVATOR);
    }
