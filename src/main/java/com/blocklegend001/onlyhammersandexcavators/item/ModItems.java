...
public class ModItems {
    ...
    public static final Item WOODEN_HAMMER = registerItem("wooden_hammer",
            new WoodenHammer(ToolMaterials.STONE, 1, -3.3F,
                    new Item.Settings().maxCount(1).maxDamage(302).attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.STONE, 1, -3.3F))));

    public static final Item STONE_HAMMER = registerItem("stone_hammer",
            new StoneHammer(ToolMaterials.STONE, 1, -3.3F,
                    new Item.Settings().maxCount(1).maxDamage(650).attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.STONE, 1, -3.3F))));

    public static final Item IRON_HAMMER = registerItem("iron_hammer",
            new IronHammer(ToolMaterials.IRON, 1, -3.3F,
                    new Item.Settings().maxCount(1).maxDamage(1300).attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.IRON, 1, -3.3F))));

    public static final Item GOLD_HAMMER = registerItem("gold_hammer",
            new GoldHammer(ToolMaterials.IRON, 1, -3.3F,
                    new Item.Settings().maxCount(1).maxDamage(750).attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.IRON, 1, -3.3F))));

    public static final Item LAPIS_HAMMER = registerItem("lapis_hammer",
            new LapisHammer(ToolMaterials.IRON, 1, -3.3F,
                    new Item.Settings().maxCount(1).maxDamage(1100).attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.IRON, 1, -3.3F))));
    ...
    public static final Item DIAMOND_HAMMER = registerItem("diamond_hammer",
            new DiamondHammer(ToolMaterials.DIAMOND, 1, -3.3F,
                    new Item.Settings().maxCount(1).maxDamage(8025).attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.DIAMOND, 1, -3.3F))));

    public static final Item EMERALD_HAMMER = registerItem("emerald_hammer",
            new EmeraldHammer(ToolMaterials.NETHERITE, 1, -3.3F,
                    new Item.Settings().maxCount(1).maxDamage(9768).attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.NETHERITE, 1, -3.3F))));

    public static final Item OBSIDIAN_HAMMER = registerItem("obsidian_hammer",
            new ObsidianHammer(ToolMaterials.DIAMOND, 1, -3.3F,
                    new Item.Settings().maxCount(1).fireproof().maxDamage(11200).attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.DIAMOND, 1, -3.3F))));

    public static final Item NETHERITE_HAMMER = registerItem("netherite_hammer",
            new NetheriteHammer(ToolMaterials.NETHERITE, 1, -3.3F,
                    new Item.Settings().maxCount(1).fireproof().maxDamage(13675).attributeModifiers(PickaxeItem.createAttributeModifiers(ToolMaterials.NETHERITE, 1, -3.3F))));
    ...
    public static final Item OBSIDIAN_EXCAVATOR = registerItem("obsidian_excavator",
            new ObsidianExcavator(ToolMaterials.DIAMOND, 1.5F, -3.0F,
                    new Item.Settings().maxCount(1).fireproof().maxDamage(11200).attributeModifiers(ShovelItem.createAttributeModifiers(ToolMaterials.DIAMOND, 1.5F, -3.0F))));
    ...
    public static final Item NETHERITE_EXCAVATOR = registerItem("netherite_excavator",
            new NetheriteExcavator(ToolMaterials.NETHERITE, 1.5F, -3.0F,
                    new Item.Settings().maxCount(1).fireproof().maxDamage(13675).attributeModifiers(ShovelItem.createAttributeModifiers(ToolMaterials.NETHERITE, 1.5F, -3.0F))));
