...
public class EmeraldHammer extends Hammer {
    public EmeraldHammer(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
        super(material, attackDamage, attackSpeed, settings.maxDamage(9768));
    }
