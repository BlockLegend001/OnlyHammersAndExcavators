...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes() {
        ...
        SmithingTransformRecipeBuilder
                ...
                .save(this.output, String.valueOf(ResourceLocation.fromNamespaceAndPath(OnlyHammersAndExcavators.MODID, "netherite_excavator")));
        ...
        SmithingTransformRecipeBuilder
                ...
                .unlocks(getHasName(Items.NETHERITE_INGOT), has(Items.NETHERITE_INGOT))
                .save(this.output, String.valueOf(ResourceLocation.fromNamespaceAndPath(OnlyHammersAndExcavators.MODID, "netherite_hammer")));
    }
}