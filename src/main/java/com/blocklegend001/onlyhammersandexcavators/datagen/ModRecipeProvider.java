...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        SmithingTransformRecipeBuilder
                ...
                .save(recipeOutput, String.valueOf(ResourceLocation.fromNamespaceAndPath(OnlyHammersAndExcavators.MODID, "netherite_excavator")));
        ...
        SmithingTransformRecipeBuilder
                ...
                .unlocks(getHasName(Items.NETHERITE_INGOT), has(Items.NETHERITE_INGOT))
                .save(recipeOutput, String.valueOf(ResourceLocation.fromNamespaceAndPath(OnlyHammersAndExcavators.MODID, "netherite_hammer")));
    }
}